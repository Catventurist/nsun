---
title: Color Mode
description: 'Muokkaus integrates with Nuxt Color Mode to allow for easy switching between light and dark themes.'
links:
...
Muokkaus automatically registers the [`@nuxtjs/color-mode`](https://github.com/nuxt-modules/color-mode) module for you, so there's no additional setup required.
