---
title: Icons
description: 'Muokkaus integrates with Nuxt Icon to access over 200,000+ icons from Iconify.'
links:
  - label: 'Iconify'
...
Muokkaus automatically registers the [`@nuxt/icon`](https://github.com/nuxt/icon) module for you, so there's no additional setup required.
