...
<template>
  <div class="mx-auto w-full max-w-3xl text-center">
    <div class="relative h-32">
      <div class="pointer-events-none absolute top-0 left-1/2 size-[480px] -translate-x-1/2 before:absolute before:inset-0 before:-z-10 before:rounded-full before:bg-linear-to-b before:from-warning/45 before:via-warning/5 before:via-25% before:to-warning/0 before:to-80%">
        <div class="h-32">
    ...
    <div class="mb-8 transition-all delay-300 duration-150 ease-in-out">
      ...
      >
        <transition-group name="testimonial-text">
          ...
          >
            <div
              class="text-2xl font-bold text-muted before:content-['\201C'] after:content-['\201D']"
            >
              {{ testimonial.quote }}
            </div>
          </div>
    ...
    <div class="mt-4 flex w-full items-center justify-between gap-4 pt-12 md:pt-0">
      ...
      >
        <Icon
          ...
          class="size-5 text-muted transition-transform duration-300 group-hover/button:rotate-12"
        />
      </button>
