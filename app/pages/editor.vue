...
const { items: mentionItems } = useEditorMentions(USERS as any)
...
![Image Placeholder](/catbirchdark.webp)
...
const collaborationEnabled = false
  ...
  <div>
    ...
    >
      <UHeader
        ...
        class="flex w-1/4 justify-around"
      >
        <EditorCollaborationUsers :users="USERS" />
